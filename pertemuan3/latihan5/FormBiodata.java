...
public class FormBiodata extends JFrame implements ActionListener, ItemListener {
    ...
    public FormBiodata() {
        ...
        LabelNama.setBounds(200, 60, 100, 30);
        kotakNama = new JTextField();
        kotakNama.setBounds(200, 90, 100, 30); // Text field below the label

        // Label Nomor HP
        JLabel LabelNoHp = new JLabel("Nomor HP:");
        LabelNoHp.setBounds(200, 120, 100, 30);
        kotakNoHp = new JTextField();
        kotakNoHp.setBounds(200, 150, 100, 30); // Text field below the label
